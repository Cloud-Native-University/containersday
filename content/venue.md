      ...
      <div class="col-md-6 mb-4">
        <div class="h-100 d-flex flex-column venue-card">
          ...
          <div class="p-4 flex-grow-1">
            <h3 class="fs-5 fw-bold text-white mb-3">📍 Sede del Evento</h3>
      ...
      <div class="col-md-6">
        <div class="p-4 mb-3 venue-card">
          <div class="d-flex align-items-center mb-3">
            ...
            <div>
              <h4 class="fs-6 fw-bold mb-0 text-white">Desde el Aeropuerto Cibao (STI)</h4>
              <small style="color: #94a3b8; font-weight: 600;">A 15 minutos de la sede</small>
            </div>
          </div>
          <p style="color: #cbd5e1; font-size: 0.85rem; line-height: 1.55; margin-bottom: 0;">
            ...
            <a href="https://www.uber.com/do/es/" target="_blank" rel="noopener" class="d-inline-block text-decoration-none ms-1 fw-semibold" style="color: #38bdf8;">
        ...
        <div class="p-4 venue-card">
          <div class="d-flex align-items-center mb-3">
            ...
            <div>
              <h4 class="fs-6 fw-bold mb-0 text-white">Desde el Aeropuerto Las Américas (SDQ)</h4>
              <small style="color: #94a3b8; font-weight: 600;">A 2.5 horas de la sede</small>
            </div>
          </div>
          <p style="color: #cbd5e1; font-size: 0.85rem; line-height: 1.55; margin-bottom: 0;">
        ...
        <div class="h-100 d-flex flex-column venue-card">
          ...
          <div class="p-3 text-center d-flex flex-column justify-content-between flex-grow-1">
            <div>
              ...
              <p class="mb-2" style="color: #cbd5e1; font-size: 0.8rem; line-height: 1.4;">Hotel de negocios con casino y piscina. A 15 min de la sede.</p>
              <p class="fw-bold mb-3" style="color: #f59e0b; font-size: 0.85rem;">Est. ~$130 - $180 / noche</p>
            </div>
        ...
        <div class="h-100 d-flex flex-column venue-card">
          ...
          <div class="p-3 text-center d-flex flex-column justify-content-between flex-grow-1">
            <div>
              ...
              <p class="mb-2" style="color: #cbd5e1; font-size: 0.8rem; line-height: 1.4;">Hotel de montaña con vista panorámica de la ciudad. A 20 min.</p>
              <p class="fw-bold mb-3" style="color: #f59e0b; font-size: 0.85rem;">Est. ~$120 - $160 / noche</p>
            </div>
        ...
        <div class="h-100 d-flex flex-column venue-card">
          ...
          <div class="p-3 text-center d-flex flex-column justify-content-between flex-grow-1">
            <div>
              ...
              <p class="mb-2" style="color: #cbd5e1; font-size: 0.8rem; line-height: 1.4;">Opción corporativa, económica y muy funcional. A 12 min.</p>
              <p class="fw-bold mb-3" style="color: #f59e0b; font-size: 0.85rem;">Est. ~$60 - $80 / noche</p>
            </div>
        ...
        <div class="h-100 d-flex flex-column venue-card">
          ...
          <div class="p-3 text-center d-flex flex-column justify-content-between flex-grow-1">
            <div>
              ...
              <p class="mb-2" style="color: #cbd5e1; font-size: 0.8rem; line-height: 1.4;">Ubicado en el centro histórico frente al parque. A 15 min.</p>
              <p class="fw-bold mb-3" style="color: #f59e0b; font-size: 0.85rem;">Est. ~$80 - $110 / noche</p>
            </div>
        ...
        <div class="h-100 d-flex flex-column venue-card">
          ...
          <div class="p-4 d-flex flex-column justify-content-between flex-grow-1">
            <div>
              ...
              <span class="d-inline-block badge mb-3" style="font-size: 0.7rem; padding: 4px 8px; background-color: rgba(255, 255, 255, 0.08); color: #cbd5e1; font-weight: 600;">Cortes & Cigar Lounge</span>
              <p class="mb-3" style="color: #cbd5e1; font-size: 0.85rem; line-height: 1.5;">Alta cocina internacional y cortes premium en un ambiente distinguido.</p>
            </div>
        ...
        <div class="h-100 d-flex flex-column venue-card">
          ...
          <div class="p-4 d-flex flex-column justify-content-between flex-grow-1">
            <div>
              ...
              <span class="d-inline-block badge mb-3" style="font-size: 0.7rem; padding: 4px 8px; background-color: rgba(255, 255, 255, 0.08); color: #cbd5e1; font-weight: 600;">Cocina Fusión Gourmet</span>
              <p class="mb-3" style="color: #cbd5e1; font-size: 0.85rem; line-height: 1.5;">Platos de autor y fusión dominicana internacional de gran calidad.</p>
            </div>
        ...
        <div class="h-100 d-flex flex-column venue-card">
          ...
          <div class="p-4 d-flex flex-column justify-content-between flex-grow-1">
            <div>
              ...
              <span class="d-inline-block badge mb-3" style="font-size: 0.7rem; padding: 4px 8px; background-color: rgba(255, 255, 255, 0.08); color: #cbd5e1; font-weight: 600;">Comida Latina Casual</span>
              <p class="mb-3" style="color: #cbd5e1; font-size: 0.85rem; line-height: 1.5;">Gastronomía caribeña y tragos en un ambiente festivo frente al Monumento.</p>
            </div>
